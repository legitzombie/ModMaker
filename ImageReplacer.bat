...
set "IMAGE_DIR=%MOD_DIR%\Image"

set "UTILS_BASE_URL=https://raw.githubusercontent.com/legitzombie/HelperBatch/main/Shareable/Utils"
set "IMAGE_BASE_URL=https://raw.githubusercontent.com/legitzombie/HelperBatch/main/Shareable/Image"
set "UNIQUE_BASE_URL=https://raw.githubusercontent.com/legitzombie/HelperBatch/main/Unique/Utils"

set "UTILS_FILES=JSON2INKATLAS.bat PNG2XBM.bat RENAMEIMAGE.bat modify_generate_inkatlas.py CREATEFOLDERS.bat ARCHIVE.bat"
...
curl -s -L -o "%MOD_DIR%\Run.bat" "%IMAGE_BASE_URL%/Run.bat"
